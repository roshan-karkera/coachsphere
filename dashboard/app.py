...
TEAM_COLORS = {'Enterprise':'#38bdf8','SMB':'#818cf8','EMEA':'#34d399','APAC':'#f472b6','VP Sales':'#fbbf24'}
...
MANAGERS = {
    ...
    'david.chen':    {'name': 'David Chen',    'team': 'VP Sales',   'password': 'Global2024'},
}
...
if 'manager' not in st.session_state:
    ...
    svg_graph = _svg_b64('graph-svgrepo-com.svg')
    svg_brain = _svg_b64('brain-svgrepo-com.svg')
    svg_robot = _svg_b64('robot-svgrepo-com.svg')
    svg_plug  = _svg_b64('plug-svgrepo-com.svg')

    _right_html = (
        '<div style="display:flex;flex-direction:column;justify-content:flex-start;padding:6vh 0 0 40px;">'
    ...
    if st.session_state.get("_processing"):
        ...
        with st.spinner("Agent thinking..."):
            try:
                ...
                # Force fresh agent with current key and tools (avoid stale module cache)
                for _mod in ["agent.graph", "agent.tools"]:
